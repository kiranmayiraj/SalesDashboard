...
{
	public TableResult fetchProductPerformance(String period, String cxt, String cxt1)
	{
		...
		if(!segFile.exists())
		{
			try 
			{
				...
				String query = "SELECT"
						...
						+ " Product,"
						+ " Revenue"
						+ " FROM `total-dreamer-274815.Staging.MV_Mimosa_TB_Performer` where Range_Chosen='"+period+"' ORDER BY Revenue DESC";
