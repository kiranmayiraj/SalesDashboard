	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			/*while(rs.next())
			{
				...
				int products = rs.getInt(3);
				float avgProductPrice = rs.getFloat(4);
				int noOfChangeInPrice = rs.getInt(5);
				int minPrice = rs.getInt(6);
				float maxPrice = rs.getFloat(7);
				int basketSize = rs.getInt(8);
				float basketValue = rs.getFloat(9);
				int noOfDisc = rs.getInt(10);
				float avgDisc = rs.getFloat(11);
				int noOfReturns = rs.getInt(12);
				float salesLost = rs.getFloat(13);
				int oThirdParty = rs.getInt(14);
				int oOnlineOrdering = rs.getInt(15);
				int oFoodPanda = rs.getInt(16);
				int oCatering = rs.getInt(17);
				int oDelivery = rs.getInt(18);
				int oToGo = rs.getInt(19);
				int oEatIn = rs.getInt(20);
				float sThirdParty = rs.getFloat(21);
				float sOnlineOrdering = rs.getFloat(22);
				float sFoodPanda = rs.getFloat(23);
				float sCatering = rs.getFloat(24);
				float sDelivery = rs.getFloat(25);
				float sToGo = rs.getFloat(26);
				float sEatIn = rs.getFloat(27);
				
				xmlResponse = "<Summary>"; 
				xmlResponse = xmlResponse + "<Orders>" + orders + "</Orders>";
				xmlResponse = xmlResponse + "<Sales>" + sales + "</Sales>";
				xmlResponse = xmlResponse + "<Products>" + products + "</Products>";
				xmlResponse = xmlResponse + "<AvgProductPrice>" + avgProductPrice + "</AvgProductPrice>";
				xmlResponse = xmlResponse + "<NoOfChangeInPrice>" + noOfChangeInPrice + "</NoOfChangeInPrice>";
				xmlResponse = xmlResponse + "<MinPrice>" + minPrice + "</MinPrice>";
				xmlResponse = xmlResponse + "<MaxPrice>" + maxPrice + "</MaxPrice>";
				xmlResponse = xmlResponse + "<BasketSize>" + basketSize + "</BasketSize>";
				xmlResponse = xmlResponse + "<BasketValue>" + basketValue + "</BasketValue>";
				xmlResponse = xmlResponse + "<NoOfDisc>" + noOfDisc + "</NoOfDisc>";
				xmlResponse = xmlResponse + "<AvgDisc>" + avgDisc + "</AvgDisc>";
				xmlResponse = xmlResponse + "<NoOfReturns>" + noOfReturns + "</NoOfReturns>";
				xmlResponse = xmlResponse + "<SalesLost>" + salesLost + "</SalesLost>";
				xmlResponse = xmlResponse + "<OThirdParty>" + oThirdParty + "</OThirdParty>";
				xmlResponse = xmlResponse + "<OOnlineOrdering>" + oOnlineOrdering + "</OOnlineOrdering>";
				xmlResponse = xmlResponse + "<OFoodPanda>" + oFoodPanda + "</OFoodPanda>";
				xmlResponse = xmlResponse + "<OCatering>" + oCatering + "</OCatering>";
				xmlResponse = xmlResponse + "<ODelivery>" + oDelivery + "</ODelivery>";
				xmlResponse = xmlResponse + "<OToGo>" + oToGo + "</OToGo>";
				xmlResponse = xmlResponse + "<OEatIn>" + oEatIn + "</OEatIn>";
				xmlResponse = xmlResponse + "<SThirdParty>" + sThirdParty + "</SThirdParty>";
				xmlResponse = xmlResponse + "<SOnlineOrdering>" + sOnlineOrdering + "</SOnlineOrdering>";
				xmlResponse = xmlResponse + "<SFoodPanda>" + sFoodPanda + "</SFoodPanda>";
				xmlResponse = xmlResponse + "<SCatering>" + sCatering + "</SCatering>";
				xmlResponse = xmlResponse + "<SDelivery>" + sDelivery + "</SDelivery>";
				xmlResponse = xmlResponse + "<SToGo>" + sToGo + "</SToGo>";
				xmlResponse = xmlResponse + "<SEatIn>" + sEatIn + "</SEatIn>";
