...
public class ChurnRevenueLost 
{
	public TableResult fetchChurnRevenueLost(String cxt, String cxt1)
	{
		...
		if(!segFile.exists())
		{
			try 
			{
				...
				String query = "SELECT"
						...
						+ " Churned_Prc,"
						+ " Revenue_Lost_Prc"
						+ " FROM `total-dreamer-274815.Staging.MV_Mimosa_Revenue_Lost` ORDER BY Segments";
