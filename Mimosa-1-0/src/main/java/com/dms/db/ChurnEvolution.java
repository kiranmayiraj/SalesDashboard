...
public class ChurnEvolution 
{
	public TableResult fetchChurnEvolution(String cxt, String cxt1)
	{
		...
		if(!segFile.exists())
		{
			try 
			{
				...
				String query = "SELECT"
						...
						+ " Tenure_Bucket,"
						+ " Churn_Rate"
						+ " FROM `total-dreamer-274815.Staging.TT_Mimosa_Churn_Evolution` ORDER BY Tenure_Bucket";
