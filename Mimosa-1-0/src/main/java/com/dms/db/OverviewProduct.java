...
{
	public TableResult fetchOverviewProduct(String period, String cxt, String cxt1)
	{
		...
		if(!segFile.exists())
		{
			try 
			{
				...
				String query = "SELECT"
						...
						+ " Repeat_Customer,"
						+ " Return_Order"
						+ " FROM `total-dreamer-274815.Staging.MV_Mimosa_Product` where Range_Chosen='"+period+"' ORDER BY Sales DESC";
