...
public class ChurnSegmentation 
{
	public TableResult fetchChurnSegmentation(String cxt, String cxt1)
	{
		...
		if(!segFile.exists())
		{
			try 
			{
				...
				String query = "SELECT"
						...
						+ " Per_Total_Customer,"
						+ " Per_Total_Churned"
						+ " FROM `total-dreamer-274815.Staging.MV_Mimosa_Churn_Segmentation`";
